...
from models.multiclass_models import build_multiclass_alphabet_model
...
def train_multiclass_alphabet_model(
    model_name: str = 'multiclass_alphabet_model',
    ...
    """
    Latih model pengenalan gestur alfabet multi-kelas
    ...
    print("\n" + "="*60)
    print("MULTI-CLASS ALPHABET GESTURE MODEL TRAINING")
    print("="*60)
    ...
    model = build_multiclass_alphabet_model(
        input_shape=input_shape,
        num_classes=num_classes,
        model_type=model_type
    )
    
    print(f"\n✅ Multi-class alphabet model built!")
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Train multi-class alphabet model')
    parser.add_argument('--model_name', type=str, default='multiclass_alphabet_model',
                       help='Model name for saving')
    parser.add_argument('--model_type', type=str, default='default',
                       choices=['simple', 'default', 'baseline'],
